...
<div class="uk-container uk-margin-large-bottom uk-margin-top">
    <h1 class="uk-heading-bullet uk-margin-top"><?= Html::encode($this->title) ?></h1>
        <div class="uk-margin-bottom">
            <?= Html::a('<i class="fa fa-plus"></i> Добавить материал',Url::to(['/admin/material-add']),['class' => 'uk-button uk-button-primary']) ?>
        </div>
                ...
                <div class="admin-holst-card uk-card uk-card-default uk-card-body uk-margin-small-bottom">
                    ...
                    <div class="--holst-card-block uk-padding-small uk-margin-remove">
                        <div class="uk-button-group">
                            <a href="<?= Url::to(['/admin/material-edit', 'id' => $material->id]) ?>" class="uk-button uk-button-default uk-button-small" title="редактировать">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                            <?= Html::a(
                                '<i class="fa fa-times" title="Удалить '.$material->name.'"></i>', 
                                [
                                    '/admin/material-delete', 'id' => $material->id
                                ], 
                                [
                                    'class' => 'uk-button uk-button-danger uk-button-small',
                                    'title' => 'Удалить "'.$material->name.'"',
                                    'data' => [
                                        'confirm' => 'Удалить "'.$material->name.'"?',
                                        'method' => 'post',
                                        ],
                                ]
                            ) ?>
