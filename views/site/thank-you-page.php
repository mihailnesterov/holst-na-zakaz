...
<div class="uk-width-1-1">
    <div class="uk-margin">
        ...
        <div class="uk-box-shadow-medium uk-text-center uk-padding uk-margin-auto-vertical">
            <h2 class="uk-heading-divider uk-text-center uk-padding-small uk-margin-remove-top">
            ...
            <h3 class="uk-text-center uk-padding-small uk-margin-remove-vertical">
                В самое ближайшее время наш менеджер свяжется с вами для уточнения деталей заказа
            </h3>
            <div class="uk-margin">
